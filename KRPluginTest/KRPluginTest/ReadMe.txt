========================================================================
    动态链接库：KRPluginTest 项目概述
========================================================================

应用程序向导已为您创建了此 KRPluginTest DLL。

本文件概要介绍组成 KRPluginTest 应用程序的每个文件的内容。
...
StdAfx.h, StdAfx.cpp
    这些文件用于生成名为 KRPluginTest.pch 的预编译头 (PCH) 文件和名为 StdAfx.obj 的预编译类型文件。
